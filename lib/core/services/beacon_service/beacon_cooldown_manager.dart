...
class BeaconCooldownManager {
  ...
  bool isInCooldown(String studentId, String classId) {
    ...
    // Cooldown expired
    _logger
        .i('✅ Cooldown expired ($minutesElapsed minutes since last check-in)');
    return false;
  }
  ...
  void setCooldown(String studentId, String classId, DateTime checkInTime) {
    ...
    _logger.i(
        '   Next check-in allowed: ${checkInTime.add(const Duration(minutes: 15))}');
  }
  ...
  void clearCooldown() {
    if (_lastCheckInTime != null) {
      ...
      _logger.i(
          '   Previous check-in: $_lastCheckInTime (student: $_lastCheckedStudentId, class: $_lastCheckedClassId)');
    }
  ...
  void restoreCooldown(String studentId, String classId, DateTime checkInTime) {
    ...
    if (minutesRemaining > 0) {
      ...
      _logger.i(
          '⏰ Cooldown expired (${timeSinceConfirmation.inMinutes} minutes ago)');
    }
  }
